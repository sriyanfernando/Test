...
namespace WebRtc.NET.Demo
{
    public partial class MainForm : Form
    {
       ...
       // List<object> Obj1AsObjects = Devices.Cast<object>().ToList();
        ...
        internal string videoDevice_2 = string.Empty;
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            videoDevice_2 = comboBox1.SelectedItem as string;
        }
        ...
        private void numericWebSocket_ValueChanged(object sender, EventArgs e)
        {

        }

        private void textBoxExtIP_TextChanged(object sender, EventArgs e)
        {
        ...
        private void pictureBoxLocal_Click(object sender, EventArgs e)
        {
